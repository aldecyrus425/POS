...
namespace POS.Domain.Entities
{
    public class Products
    {
        ...
        public int ReorderLevel { get; private set; } // Minimum stock level before reordering
        public bool IsTrackInventory { get; private set; } // Whether the product's inventory is tracked
        ...
        public Products(string barcode, string sku, string name, string description, int categoryId, int unitId, decimal costPrice, decimal sellingPrice, int reorderLevel, bool isTrackInventory, bool isActive, string imageUrl)
        {
        ...
        public void UpdateProduct(string barcode, string sku, string name, string description, int categoryId, int unitId, decimal costPrice, decimal sellingPrice, int reorderLevel, bool isTrackInventory, bool isActive, string? imageUrl)
        {
            if (string.IsNullOrWhiteSpace(barcode))
                throw new ArgumentException("Barcode is required.", nameof(barcode));
